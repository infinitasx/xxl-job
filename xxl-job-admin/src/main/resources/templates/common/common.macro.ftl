	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobinfo">active</#if>" ><a href="${request.contextPath}/jobinfo?systemName=delivery"><i class="fa fa-circle-o text-red"></i><span>${I18n.delivery_jobinfo_name}</span></a></li>
